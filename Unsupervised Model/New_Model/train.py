...
if __name__ == "__main__":
    #model = VCD(12, 8, 64, 64, 128, 0.2).to(device)
    model = VCD(128, 10, 50, 64, 128, 0.2).to(device)
    #model.load_state_dict(torch.load('./model.pth'))
    #model.to(device)
    #model.train()

    trainset = MyDataset('dataset\\train_x.npy','dataset\\train_y.npy')#, transform1=transform1, transform2 = transform2)
